...
//struct ast *ast_if_condition_add(struct ast *ast, struct ast *condition);   // add condition to if node, if ast not found init a if node and add the condition NO NEED FOR THOSE
